...
KT=".Codex/skills/koder-ticket/koder-ticket.sh"
# On Koda's PC, from any directory:
KT="$HOME/.Codex/skills/koder-ticket/koder-ticket.sh"
...
(`.Codex/skills/koder-ticket/SKILL.md`; the CLI's source of truth is
`scripts/koder-ticket.sh` there). Edit it there, then run
`scripts/sync-skill.sh` to propagate to `~/.Codex/skills/` and the other
